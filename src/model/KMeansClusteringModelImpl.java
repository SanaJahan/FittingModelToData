...
public class KMeansClusteringModelImpl {
  ...
  // And then the other set of variables we use is mu subscript k, which is the location of cluster centroid k.
  ...
  // hence we need a method to find the center of the cluster-> elbow method to find the right k
